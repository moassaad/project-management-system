...
/**
 * Map RFC 9457 422 add-comment body to form field errors using `status` +
 * `errors[]` (never parses human-readable `detail` for control flow;
 * pointer selects the field: #/content → content).
 */
export function mapAddCommentErrors(error: unknown): {
